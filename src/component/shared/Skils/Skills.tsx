...
const Skills = async () => {
  ...
  const res = await fetch(`${process.env.BACKEND_URL}/skills`); //ssg // incremental static site regenration
  ...
  return (
    <div className="grid grid-cols-2 lg:gap-4 gap-2 md:grid-cols-2 lg:grid-cols-4  ">
      ...
      {skills?.data.map((skill:any, index:number) => (
        <div
          key={index}
          className="flex items-center border border-[#3c91b2]  rounded-lg p-3 max-w-[240px] bg-gray-50 hover:bg-[#b9e1f1] cursor-pointer shadow-md z-30"
        >
          <div className="mr-3">{icons[index]}</div>
          <div>
